...
python merge_colinear_chain.py -c v1.1_to_v1.0_rdna.chain -o v1.1_to_v1.0_rdna_merged.chain
...
python merge_colinear_chain.py -c v1.0_to_v1.1_rdna.chain -o v1.0_to_v1.1_rdna_merged.chain
